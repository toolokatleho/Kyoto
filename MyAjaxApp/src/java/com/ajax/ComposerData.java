...
public class ComposerData {
    ...
    public ComposerData() {
        ...
        composers.put("1", new Composer("1", "John Seba", "Deco", "Baroque"));
        ...
        composers.put("15", new Composer("15", "Protocol Pro", "Kyoto", "Classical"));
        composers.put("16", new Composer("16", "Katleho", "Toolo", "Classical"));
        ...
        composers.put("22", new Composer("22", "SnapJay", "Salad", "Romantic"));
        ...
        composers.put("26", new Composer("26", "Ngoana_Sesi", "Skomota", "Romantic"));
